...
HARD RULES:
- One sentence per beat. No semicolons chaining a second clause. The em-dash, the comma series, and "and" are NOT licenses to pack a second claim or a list of items into a beat — ONE claim, AT MOST one supporting anchor, per beat. If you find yourself naming two facts or two sources in one beat, keep the single most load-bearing one and drop the rest (it already lives in the full verdict).
- 80 words MAXIMUM across all three beats combined. Three taut assertions, not three paragraphs. Shorter is better; a sharp 60-word lead beats a padded 80.
